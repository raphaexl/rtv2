...
/*   Updated: 2019/09/22 13:46:59 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_inspector_display4(t_ptr *ptr, t_inspector *ins)
{
	...
	ft_entry_draw(ptr, &ins->v3[8].e[1], DEFAULT_W + 10,
			START_Y + 22 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v3[8].e[2], 2 * DEFAULT_W + 15,
			START_Y + 22 * DEFAULT_H);
	ft_button_draw(ptr, &ins->v3[9].b, 40, START_Y + 23 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v3[9].e[0], 5, START_Y + 24 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v3[9].e[1], DEFAULT_W + 10,
			START_Y + 24 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v3[9].e[2], 2 * DEFAULT_W + 15,
			START_Y + 24 * DEFAULT_H);
	ft_button_draw(ptr, &ins->v4[0].b, 40, START_Y + 25 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v4[0].e[0], 5, START_Y + 26 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v4[0].e[1], DEFAULT_W + 10,
			START_Y + 26 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v4[0].e[2], 2 * DEFAULT_W + 15,
			START_Y + 26 * DEFAULT_H);
	ft_entry_draw(ptr, &ins->v4[0].e[3], 3 * DEFAULT_W + 20,
			START_Y + 26 * DEFAULT_H);
}
