...
/*   Updated: 2019/09/24 16:36:27 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_env_load_pos(t_env *env)
{
	...
	env->menu.pos[13] = (SDL_Rect){.x = 80 + START_X, .y = END_Y + 50};
	env->menu.pos[14] = (SDL_Rect){.x = 80 + START_X, .y = END_Y + 10};
	env->menu.pos[15] = (SDL_Rect){.x = 140 + START_X, .y = END_Y + 10};
	env->menu.pos[16] = (SDL_Rect){.x = 200 + START_X, .y = END_Y + 50};
	env->menu.pos[17] = (SDL_Rect){.x = START_X + 140, .y = END_Y + 50};
}
