...
/*   Updated: 2019/07/03 13:16:03 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_env_load_pos(t_env *env)
{
	...
	env->menu.pos[17] = (SDL_Rect){.x = 420 + START_X, .y = END_Y + 10};
	env->menu.pos[18] = (SDL_Rect){.x = 720 + START_X, .y = END_Y + 10};
	env->menu.pos[19] = (SDL_Rect){.x = START_X + 420, .y = END_Y + 50};
	env->menu.pos[20] = (SDL_Rect){.x = 720 + START_X, .y = END_Y + 50};
}
