...
/*   Updated: 2019/09/18 15:57:35 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	perlin->x = (int)floor(v->x) % 255;
	...
	perlin->x = perlin->x > 0 ? perlin->x : 255 + perlin->x;
	perlin->y = perlin->y > 0 ? perlin->y : 255 + perlin->y;
	perlin->z = perlin->z > 0 ? perlin->z : 255 + perlin->z;*/
	perlin->x = ((int)floor(v->x)) & 255;
	perlin->y = ((int)floor(v->y)) & 255;
	perlin->z = ((int)floor(v->z)) & 255;
	v->x -= floor(v->x);
