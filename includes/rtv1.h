...
/*   Updated: 2019/05/17 20:13:55 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec3		ft_normal_box(t_object *cone, t_vec3 p);
int			ft_box_intersect(t_object *box, t_ray *r, float *t);
int			ft_box_compute(t_object *b, t_intersect *in);

t_object	*ft_torus_new(void);
t_vec3		ft_normal_torus(t_object *cone, t_vec3 p);
int			ft_torus_intersect(t_object *box, t_ray *r, float *t);
int			ft_torus_compute(t_object *b, t_intersect *in);

int			ft_solve_quadric(double c[3], double s[2]);
int			ft_solve_cubic(double c[4], double s[3]);
int			ft_solve_quartic(double c[5], double s[4]);
...
SDL_Texture	*ft_get_render_text(SDL_Renderer *rend, t_font f, SDL_Color col3);
